...
public:
	...
	bool IsCurrentAnimationNumber(UINT checkedAnimationNumber) { if (m_CurrentAnimationNumber == checkedAnimationNumber) { return true; } return false; };

private:
	UINT m_CurrentAnimationNumber;
