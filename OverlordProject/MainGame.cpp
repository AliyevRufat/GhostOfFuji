...
#endif
#ifdef Game
#include "CourseObjects/Game/ExamGameScene.h"
#include "CourseObjects/Game/ExamGameMainMenuScene.h"
#endif
...
#endif
#ifdef Game
	SceneManager::GetInstance()->AddGameScene(new ExamGameMainMenuScene());
	SceneManager::GetInstance()->AddGameScene(new ExamGameScene());
