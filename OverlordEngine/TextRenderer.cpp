...
DirectX::XMFLOAT2 TextRenderer::GetWindowWidthHeight()
{
	DirectX::XMFLOAT2 windowWH;
	const auto settings = OverlordGame::GetGameSettings();

	windowWH.x = (float)settings.Window.Width;
	windowWH.y = (float)settings.Window.Height;
