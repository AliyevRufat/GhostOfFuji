...
bool OverlordGame::m_EndGame = false;
...
OverlordGame::~OverlordGame()
{
	...
	ParticleEffectManager::DestroyInstance();
...
void OverlordGame::GameLoop() const
{
	...
	//delete marked gameobjects
	SceneManager::GetInstance()->GetActiveScene()->EraseDeletedObjects();
}
